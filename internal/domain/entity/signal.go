...
type Signal struct {
	...
	// Trade Management (For complex strategies)
	StopLossPrice decimal.Decimal // Dynamic Stop Loss
	TargetPrice1  decimal.Decimal // Take Profit 1
...
// SetTradeLevels sets the trade levels (SL, TP1, TP2)
func (s *Signal) SetTradeLevels(sl, tp1, tp2 decimal.Decimal) {
	s.StopLossPrice = sl
	s.TargetPrice1 = tp1
	s.TargetPrice2 = tp2
}
